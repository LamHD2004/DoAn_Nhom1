                ...
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="form-wrapper wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".2s">
                        <div class="form-title">
                            <h3>Log In</h3>
                            <p>New Member? <a href="ShowFormSignup">signup here</a></p>
                        </div>
                        <form action="{{route('getLogin')}}" method="POST" class="w-100">
                            @csrf
                            <div class="row">
                                <div class="col-12">
            ...
            <div class="row g-4 d-flex justify-content-center">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-10 col-10">
                    <div class="counter-single text-center d-flex flex-row hover-border1 wow fadeInDown"
                        ...
                        <div class="counter-icon"> <img alt="imges" src="assets/images/icons/employee.svg"> </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-10 col-10">
                    <div class="counter-single text-center d-flex flex-row hover-border1 wow fadeInDown"
                        ...
                        <div class="counter-icon"> <img alt="imges" src="assets/images/icons/review.svg"> </div>
                        <div class="coundown d-flex flex-column">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-10 col-10">
                    <div class="counter-single text-center d-flex flex-row hover-border1 wow fadeInDown"
                        ...
                        <div class="counter-icon"> <img alt="imges" src="assets/images/icons/smily.svg"> </div>
                        <div class="coundown d-flex flex-column">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-10 col-10">
                    <div class="counter-single text-center d-flex flex-row hover-border1 wow fadeInDown"
                        ...
                        <div class="counter-icon"> <img alt="imges" src="assets/images/icons/comment.svg"> </div>
                        <div class="coundown d-flex flex-column">
